...
public class StringClass1 {
	...
	public static void main(String[] args) {
		...
		string1="Esto es un literal cadena";  //Se le da un valor inicial a la cadena con el operador de asignaciÃ³n =
		...
		System.out.println(String.valueOf(i)+(100+i)); //Concatenación de cadenas
	}
